        ...
        <div class="container container-body">
            <form action="do-login.jsp" method="POST">
                ...
                <div class="form-group form-check">
                  ...
                  <label class="form-check-label" for="exampleCheck1" id="labelFormCheck">Check me out</label>
                </div>
                <button type="submit" class="btn btn-primary">Login</button>
            </form>
            <a href="register.jsp" class="aHref">Dont have an account yet ? Register here !</a>
        </div>
    </div>
